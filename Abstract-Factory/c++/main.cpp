 ...
 */
 ...
 public:
     virtual AbstractProductA *CrateProductA() const=0;
     virtual AbstractProductB *CrateProductB() const=0;
 };
 ...
 */
 ...
 public:
     AbstractProductA *CrateProductA() const override{
     return new ConcreteProductA1();
     }

     AbstractProductB *CrateProductB() const override{
 ...
 */
 ...
 const AbstractProductA *product_a=factory.CrateProductA();
 const AbstractProductB *product__b=factory.CrateProductB();
 cout<<product__b->UsefulFunctionB()<<"\n";
 cout<<product__b->AnotherUsefulFunctionB(*product_a)<<"\n";
 delete product_a;
 delete product__b;
 }
